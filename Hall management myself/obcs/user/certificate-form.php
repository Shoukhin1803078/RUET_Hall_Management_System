...
$query->bindParam(':email',$email,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Dalan capa Hall Registration applied succesfully")</script>';
                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post">
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Input your image:</label>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Transcript image/pdf:</label>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro"> Nationality Testimonial:</label>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro"> Attachment photocopy:</label>
                                                        ...
                                                        <!-- <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Full Name1</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="fname" value="" required="true" />
                                                                </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Full Name2</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="fname" value="" required="true" />
                                                                </div>
 ...
 -->
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                   <input type="text" class="form-control" required="true" value="" name="mobnumber" maxlength="4" pattern="[0-9]+" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="dept" value="" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">CGPA </label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="cgpa" value="" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="session" value="" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                       ...
                                                       <div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">NID number</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="nid" value="" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
